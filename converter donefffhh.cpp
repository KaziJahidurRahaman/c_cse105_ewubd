...
/*---------------Currency conversion------------*/
int US_DollarToTaka(float *, float *);
int TakaToUS_Dollar(float *, float *);
int BRITISH_PoundToTaka(float *, float *);
int TakaToBRITISH_Pound(float *, float *);
...
int US_DollarToTaka(float *ud, float *tk)
{
  *tk = (*ud) * 78.08;
  return(*tk);
}

int TakaToUS_Dollar(float *tk, float *ud)
{
  *ud = (*tk) * 0.0128;
  return(*ud);
}

int BRITISH_PoundToTaka(float *bp, float *tk)
{
  *tk = (*bp) * 117.987;
  return(*tk);
}

int TakaToBRITISH_Pound(float *tk, float *bp)
{
  *bp = (*tk) * 0.00847;
  return(*bp);
}
...
void Currency_Conversion(void)
{
  ...
  do
  {
   // system("clear");
    ...
    printf("\n\t\t| 1.|US_Dollar To Taka            |  ");
    printf("\n\t\t| 2.|Taka To US_Dollar            |  ");
    printf("\n\t\t| 3.|BRITISH_Pound To Taka        |  ");
    printf("\n\t\t| 4.|Taka To BRITISH_Pound        |  ");
    printf("\n\t\t+---+-----------------------------+  ");
	...
	printf("\n\n\tExit from Currency Converter....\n\n");
      ...
      case 1:
        printf("\n\t......US_Dollar To Taka Converter......\n");
        printf("\n\tEnter the value US_Dollar : ");
        scanf("%f",&ud);
        US_DollarToTaka(&ud, &tk);
        printf("\n\tValue in Taka : %f \n", tk);
        break;

      case 2:
        printf("\n\t......Taka To US_Dollar Converter......\n");
        printf("\n\tEnter the value Taka : ");
        scanf("%f",&tk);
        TakaToUS_Dollar(&tk, &ud);
        printf("\n\tValue in US_Dollar : %f \n", ud);
        break;

      case 3:
        printf("\n\t......BRITISH_Pound To Taka Converter......\n");
        printf("\n\tEnter the value BRITISH_Pound : ");
        scanf("%f",&bp);
        BRITISH_PoundToTaka(&bp, &tk);
        printf("\n\tValue in Taka : %f \n", tk);
        break;

      case 4:
        printf("\n\t......Taka To BRITISH_Pound Converter......\n");
        printf("\n\tEnter the value Taka : ");
        scanf("%f",&tk);
        TakaToBRITISH_Pound(&tk, &bp);
        printf("\n\tValue in BRITISH_Pound : %f \n", bp);
        break;
...
int main(void)
{
  ...
  {
    //system("clear");
    printf("\n\n\t\t\tWelcome to Multi Tasking Converter...\n\n\n\n\n\n");
    printf("\n\t\t        :: Tasks ::   ");
    printf("\n\t\t+---+-----------------------+  ");
